...
async def get_default():
    client = DbClient()
    abiturients = client["abiturients"]
    return {group_name: update_rating(add_students_names(abiturients[group_name].find({}))) for group_name in group_names}
...
async def get_original_docs_without_agreement():
    ...
    abiturients = client["abiturients"]
    return {group_name: update_rating(add_students_names(abiturients[group_name].find(query))) for group_name in group_names}
